    ...
    return (
        <div className="page home-page">
            <header className="topbar">
                <div className="logo">TutorFlow</div>
            ...
            <main className="home-content">
                ...
                <section className="role-cards">
                    <div className="role-card">
                        ...
                        <button onClick={() => handleRegister('TUTOR')} className="text-button">
                            Register as a Tutor →
                        </button>
                    </div>
                    ...
                    <div className="role-card">
                        ...
                        <button onClick={() => handleRegister('STUDENT')} className="text-button">
                ...
                <section className="how-it-works">
                    ...
                    <div className="steps">
                        <div className="step">
                            ...
                            <h3>Create Slots</h3>
                            <p>Tutors set up their available time slots with subject details.</p>
                        </div>
                        <div className="step">
                            <div className="step-number">2</div>
                            <h3>Book Lessons</h3>
                            <p>Students browse and book suitable time slots.</p>
                        </div>
                        <div className="step">
                            <div className="step-number">3</div>
                            <h3>Confirm & Learn</h3>
                            <p>Tutors confirm bookings and lessons proceed as scheduled.</p>
                        </div>
                    </div>
                </section>
            </main>
